...
export default class ActualizarDatosTienda extends Component {
    ...
    ActualizarDatosUsuario = (google_id, nombre, direccion, telefono) => {
        ...
        axios.patch(backurl + "stores/" + google_id, nueva_informacion_usuario)
            .then(result => { global.user = result.data; Alert.alert("Datos actualizados correctamente"); Actions.VistaMenuTienda(); })
