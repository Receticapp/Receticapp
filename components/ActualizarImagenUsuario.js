...
export default class ActualizarImagenUsuario extends React.Component {
  state = {
    image: null,
    uploading: false,
  };
  ...
  ActualizarFoto = (image) => {
    if (image != null) {
      ...
      axios.patch(this.props.url, parametros)
        .then(result => { Alert.alert("Foto Actualizada Correctamente"); setTimeout(() => { Actions.VistaMenuUsuario(); }, 2000); })
